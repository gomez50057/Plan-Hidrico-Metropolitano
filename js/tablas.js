const simbologiaData = {
  ...
  DR: [
    { color: "#cde398", text: "112 Ajacuba" },
    { color: "#7cb45b", text: "100 Alfajayucan" },
    { color: "#899d60", text: "003 Tula" }
  ],
  moduloR: [
    { color: "#ffd50b", text: "Tierra" },
    { color: "#2381bb", text: "Revestido" },
    { color: "#f70000", text: "2025" }
  ],
};
