...
var Distrito_de_Riego_100_Alfajayucan = GeoJSONDistRiego(Distrito_de_Riego_100_Alfajayucan, '#7cb45b');
var Distrito_de_Riego_112_Ajacuba = GeoJSONDistRiego(Distrito_de_Riego_112_Ajacuba, '#cde398');
var Distrito_de_Riego_003_Tula = GeoJSONDistRiego(Distrito_de_Riego_003_Tula, '#899d60');


function GeoJSONDistRiego(data, fillColor) {
  return L.geoJSON(data, {
    style: function (feature) {
      return {
        fillColor: fillColor,
    ...
    onEachFeature: function (feature, layer) {
      var numcultivo = feature.properties.numcultivo.toLocaleString();
      var spsembrada = feature.properties.spsembrada.toLocaleString();
      var spcosechad = feature.properties.spcosechad.toLocaleString();
      var produccion = feature.properties.produccion.toLocaleString();
      var valproducc = feature.properties.valproducc.toLocaleString();

      layer.bindPopup("<div class='PopupT'>" + "<b>Distrito de Riego</b> " + feature.properties.clvdr + " " + feature.properties.dr + "</div>" +
        "<b>Región Hidroagrícola:</b> " + feature.properties.clvrha + " " + feature.properties.rha +
        "<br><b>Año Agrícola:</b> " + feature.properties.anioagrico +
        "<br><b>Número de Cultivo:</b> " + numcultivo +
        "<br><b>Superficie Sembrada:</b> " + spsembrada +
        "<br><b>Superficie Cosechada:</b> " + spcosechad +
        "<br><b>Producción:</b> " + produccion +
        "<br><b>Valor de la Producción:</b> " + valproducc);
    }
  }).addTo(map);
}
...
var layers = [
  ...
  //Distritos de Riego 
  { layer: Distrito_de_Riego_112_Ajacuba, checkbox: chk112Ajacuba },
  { layer: Distrito_de_Riego_100_Alfajayucan, checkbox: chk100Alfajayucan },
  { layer: Distrito_de_Riego_003_Tula, checkbox: chk003Tula },
